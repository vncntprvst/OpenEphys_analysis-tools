...
% Structure should look like that:
% HDF5 experiment1_100.raw.kwd 
% Group '/' 
%     Attributes:
%         'kwik_version':  2
%     Group '/recordings' 
%         Group '/recordings/0' 
%             Attributes:
%                 'name':  'Open Ephys Recording #0'
%                 'start_time':  0
%                 'start_sample':  0
%                 'sample_rate':  30000.000000
%                 'bit_depth':  16
%             Dataset 'data' 
%                 Size:  35x1762800
%                 MaxSize:  35xInf
...
%                 FillValue:  0
%                 Attributes:
%                     'valid_samples':  'H5T_ARRAY'
%             Group '/recordings/0/application_data' 
%                 Attributes:
%                     'channel_bit_volts':  'H5T_ARRAY'
%                     'is_multiSampleRate_data':  0
%                     'channel_sample_rates':  'H5T_ARRAY'
